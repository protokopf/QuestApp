...
namespace Justus.QuestApp.ModelLayer.UnitTests.CommandsTest.QuestCommandsTest.Tree
{
    ...
    class UpdateQuestCommandTests
    {
        ...
        public void CtorNullTest()
        {
            ...
            //Act
            ArgumentNullException ex = Assert.Throws<ArgumentNullException>(() => new UpdateQuestCommand(null));
        ...
        public void ExecuteTest()
        {
            ...
            tree.Expect(tr => tr.Update(Arg<Quest>.Is.Equal(quest))).Repeat.Once();
